...
use crate::gfx::shaders::{LightDir, MaterialTex, MaterialTexMap, VSMatrices};
...
impl DemoImpl {
    ...
    fn init(&mut self, system: &system::System) -> Result<(), String> {
        ...
        self.cube_shader = Shaders::from_files(
            &system.gl,
            "./demo/demo9_box.vs",
            "./demo/demo10_box_dir.fs",
        )?;

        self.cube_sm_shader = Shaders::from_files(
            &system.gl,
            "./demo/demo9_box.vs",
            "./demo/demo10_box_specular_map_dir.fs",
        )?;
        ...
        self.light.direction = Vec3::new(-0.2, -1.0, -0.3);
